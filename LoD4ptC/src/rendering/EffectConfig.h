...
namespace Effects
{
	namespace config {
		...
		const std::vector<std::string> VS_NAMES =
		{
			"VS_PASSTHROUGH", 
			"VS_APPLY_DEPTHCOLOR", 
			"VS_RADIUS_PASSTHROUGH",
			"VS_RADIUS_APPLY_DEPTHCOLOR",
		...
		const std::vector<std::string> GS_NAMES =
		{
			"GS_UNLIT",
			"GS_LIT",
			"GS_ADAPTIVESPLATSIZE",
			"GS_ADAPTIVESPLATSIZE_DEPTHCOLOR",
			"GS_ORIENTED_ADAPTIVESPLATSIZE",
			"GS_ORIENTED_ADAPTIVESPLATSIZE_DEPTHCOLOR",
			"GS_RADIUS",
			"GS_RADIUS_ORIENTED", 
			"GS_ELLIPTICAL",
		};
		...
		const D3D11_INPUT_ELEMENT_DESC LAYOUT_POS3_NOR3_COL4_RADIUS1[] =
		{
		{ "SV_POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
		{ "NORMAL", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
		{ "COLOR", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 },
		...
		const int layoutSizeSpherical = ARRAYSIZE(LAYOUT_POS3_NOR3_COL4_RADIUS1);
